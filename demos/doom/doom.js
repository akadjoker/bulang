...
(() => {
  ...
  async function loadPackage(metadata) {
    ...
    var PACKAGE_NAME = "build/doom.data";
    ...
    async function runWithFS(Module) {
      ...
      Module["FS_createPath"]("/assets", "demos", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_build/doom.data");
      }
      Module["addRunDependency"]("datafile_build/doom.data");
  ...
  loadPackage({
    "files": [ {
      ...
      "filename": "/assets/demos/basic.bu",
      "start": 93,
      "end": 1384
    }, {
      "filename": "/assets/demos/doom.bu",
      "start": 1384,
      "end": 15826
    }, {
      "filename": "/assets/main.bu",
      "start": 15826,
      "end": 15879
    } ],
    "remote_package_size": 15879
  });
})();

// end include: /tmp/tmp925qungg.js
// include: /tmp/tmphxl6434d.js
...
// end include: /tmp/tmphxl6434d.js
// include: /tmp/tmplwtggkju.js
...
// end include: /tmp/tmplwtggkju.js
var arguments_ = [];
...
var Asyncify = {
  ...
  setDataHeader(ptr, stack, stackSize) {
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, ((ptr) >> 2), "storing")] = stack;
    HEAPU32[SAFE_HEAP_INDEX(HEAPU32, (((ptr) + (4)) >> 2), "storing")] = stack + stackSize;
  },
  setDataRewindFunc(ptr) {
    var bottomOfCallStack = Asyncify.exportCallStack[0];
    assert(bottomOfCallStack, "exportCallStack is empty");
    var rewindId = Asyncify.getCallStackId(bottomOfCallStack);
    HEAP32[SAFE_HEAP_INDEX(HEAP32, (((ptr) + (8)) >> 2), "storing")] = rewindId;
    checkInt32(rewindId);
  },
  getDataRewindFunc(ptr) {
    var id = HEAP32[SAFE_HEAP_INDEX(HEAP32, (((ptr) + (8)) >> 2), "loading")];
...
var ASM_CONSTS = {
  ...
  106106: () => (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined),
  106210: () => {
    try {
  ...
  109209: $0 => miniaudio.get_device_by_index($0).webaudio.sampleRate,
  109275: $0 => {
