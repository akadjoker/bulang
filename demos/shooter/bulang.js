...
// include: /tmp/tmp0gd2iodd.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/bulang.data';
      var REMOTE_PACKAGE_BASE = 'bulang.data';
...
Module['FS_createPath']("/assets", "plataform", true, true);
Module['FS_createPath']("/assets", "space_shooter", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_build/bulang.data');
      }
      Module['addRunDependency']('datafile_build/bulang.data');
    ...
    loadPackage({"files": [{"filename": "/assets/.gitkeep", "start": 0, "end": 0}, {"filename": "/assets/flixel.bu", "start": 0, "end": 1641}, {"filename": "/assets/main.bu", "start": 1641, "end": 1692}, {"filename": "/assets/plataform/consts.bu", "start": 1692, "end": 2468}, {"filename": "/assets/plataform/platform.bu", "start": 2468, "end": 3157}, {"filename": "/assets/plataform/player.bu", "start": 3157, "end": 8171}, {"filename": "/assets/space_shooter.bu", "start": 8171, "end": 16355}, {"filename": "/assets/space_shooter/bullet.bu", "start": 16355, "end": 17092}, {"filename": "/assets/space_shooter/const.bu", "start": 17092, "end": 17905}, {"filename": "/assets/space_shooter/enemy.bu", "start": 17905, "end": 19669}, {"filename": "/assets/space_shooter/player.bu", "start": 19669, "end": 24366}], "remote_package_size": 24366});

  })();

// end include: /tmp/tmp0gd2iodd.js
// include: /tmp/tmpywfuyv2j.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpywfuyv2j.js
// include: /tmp/tmp6_ng57v8.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp6_ng57v8.js
...
var ASM_CONSTS = {
  5296093: () => { if (document.fullscreenElement) return 1; },  
 5296139: () => { return Module.canvas.width; },  
 5296171: () => { return parseInt(Module.canvas.style.width); },  
 5296219: () => { document.exitFullscreen(); },  
 5296246: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 5296318: () => { if (document.fullscreenElement) return 1; },  
 5296364: () => { return Module.canvas.width; },  
 5296396: () => { return screen.width; },  
 5296421: () => { document.exitFullscreen(); },  
 5296448: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 5296581: () => { return window.innerWidth; },  
 5296607: () => { return window.innerHeight; },  
 5296634: () => { if (document.fullscreenElement) return 1; },  
 5296680: () => { return Module.canvas.width; },  
 5296712: () => { return parseInt(Module.canvas.style.width); },  
 5296760: () => { if (document.fullscreenElement) return 1; },  
 5296806: () => { return Module.canvas.width; },  
 5296838: () => { return screen.width; },  
 5296863: () => { return window.innerWidth; },  
 5296889: () => { return window.innerHeight; },  
 5296916: () => { if (document.fullscreenElement) return 1; },  
 5296962: () => { return Module.canvas.width; },  
 5296994: () => { return screen.width; },  
 5297019: () => { document.exitFullscreen(); },  
 5297046: () => { if (document.fullscreenElement) return 1; },  
 5297092: () => { return Module.canvas.width; },  
 5297124: () => { return parseInt(Module.canvas.style.width); },  
 5297172: () => { document.exitFullscreen(); },  
 5297199: ($0) => { Module.canvas.style.opacity = $0; },  
 5297237: () => { return screen.width; },  
 5297262: () => { return screen.height; },  
 5297288: () => { return window.screenX; },  
 5297315: () => { return window.screenY; },  
 5297342: () => { return window.devicePixelRatio; },  
 5297378: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 5297431: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 5297482: () => { Module.canvas.style.cursor = 'none'; },  
 5297519: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 5297775: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 5297826: () => { if (document.pointerLockElement) return 1; },  
 5297873: () => { if (document.fullscreenElement) return 1; },  
 5297919: () => { return window.innerWidth; },  
 5297945: () => { return window.innerHeight; }
};
